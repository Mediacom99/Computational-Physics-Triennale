...
X = np.genfromtxt("dataQuadrupla.txt", delimiter=',',dtype=int, usecols=1)
Y = np.genfromtxt("dataQuadrupla.txt", delimiter=',',dtype=float, usecols=0)
