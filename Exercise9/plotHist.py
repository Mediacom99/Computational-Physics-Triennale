...
x = numpy.genfromtxt("dati.txt", delimiter=' ',dtype=float, usecols=1)
...
str = "Risultato fit:\n"+r'$ \sigma_{u} = $'+"{}".format(norm.stdev)

ax.text(-0.035,30,str)

ax.legend(["Fit Gaussiano","istogramma pdf Bernoulli Trial"])
plt.grid(False);
