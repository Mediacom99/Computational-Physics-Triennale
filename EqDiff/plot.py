...
X = np.genfromtxt("DataRK2.txt", delimiter=',',dtype=float, usecols=0)
Y = np.genfromtxt("DataRK2.txt", delimiter=',',dtype=float, usecols=1) 
...
ax.legend(["Eulero","Runge-Kutta 2"])
...
ax.set(xlim=(0,np.amax(x)),ylim=(-1.5,1.5))
